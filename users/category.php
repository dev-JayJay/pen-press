...
$category = isset($_GET['cat']) ? $_GET['cat'] : 'sport';
$allowed_categories = ['sport','business','features'];
...
<div class="sidebar d-flex flex-column">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2">
            <a class="nav-link <?php echo $category=='sport'?'active':''; ?>" href="category.php?cat=sport">Sports</a>
        </li>
        <li class="nav-item mb-2">
            <a class="nav-link <?php echo $category=='business'?'active':''; ?>" href="category.php?cat=business">Business</a>
        </li>
        <li class="nav-item mb-2">
            <a class="nav-link <?php echo $category=='features'?'active':''; ?>" href="category.php?cat=features">Features</a>
        </li>
